    ...
    <section className="text-white p-10 md:p-20">
      <div className="container mx-auto px-4">
        ...
        <div className="space-y-6">
          {/* Step 1 */}
          <div className="bg-slate-700 p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-evenly items-center space-y-6 md:space-y-0">
          ...
          {/* Step 2 */}
          <div className="bg-slate-800 p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-evenly items-center space-y-6 md:space-y-0">
            <div className="md:w-1/5 order-2 md:order-1">
              <img src={team} alt="Team Consultation" className="w-full h-auto mx-auto" />
            </div>
            <div className="md:w-4/5 md:pr-10 order-1 md:order-2">
